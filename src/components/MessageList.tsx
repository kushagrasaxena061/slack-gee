...
const MessageList = ({
  ...
  return (
    <div className="flex-1 bg-neutral-900 text-white  overflow-y-auto  messages-scrollbar">
      {Object.entries(groupedMessages || {}).map(([dateKey, messages]: any) => (
        <div key={dateKey}>
          <div className="text-center text-white ">
            <div className="absolute text-white border-t border-[#A64D79]" />
            <span className="relative text-white inline-block bg-neutral-900  rounded-full text-sm border border-[#A64D79] shadow-sm">
