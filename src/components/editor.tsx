...
const Editor = ({
  ...
  return (
    <div className="flex flex-col messages-scrollbar">
      ...
      <div
        className={cn(
          "flex flex-col border border-slate-200 rounded-md overflow-hidden foucs-within:border-slate-300 focus-within:shadow-sm transition bg-white",
          disabled && "opacity-50"
        )}
      >
          ...
          <div className="p-2">
            <div className="relative size-[62px] flex items-center justify-center group/image">
              <Hint label="Remove Image">
                ...
                >
                  <XIcon className="size3.5 text-red-600" />
                </button>
              </Hint>
              <Image
