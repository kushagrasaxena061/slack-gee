...
export const Thread = ({ messageId, onClose }: ThreadProps) => {
  ...
  return (
    <div className=" bg-neutral-900 text-white ">
      ...
      {/* message-scrollbar do not remove */}
      <div className=" messages-scrollbar">
        {Object.entries(groupedMessages || {}).map(
          ([dateKey, messages]: any) => (
            <div key={dateKey} className="text-[#A64D79]">
              <div className="text-center text-white ">
                <div className=" text-whiteborder-t border-[#A64D79]" />
                <span className="relative text-white inline-block bg-neutral-900 rounded-full text-sm border border-[#A64D79]">
